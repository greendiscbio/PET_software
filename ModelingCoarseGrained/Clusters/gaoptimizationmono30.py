...
for task in tasks_clusters:
    ...
    if numpy.sum(y_data)!=0:
        par = []
        for k in range(0,20):
            SVM = random.choices(['SVM1','SVM2','SVM3'],[4/9,3/9,2/9],k=1)[0]
            AN = random.choices(['AN1','AN2','AN3'],[4/9,4/9,1/9],k=1)[0]
            EL = random.choices(['EL1','EL2','EL3'],[4/8,1/8,3/8],k=1)[0]
            MR = random.choices(['MR1','MR2','MR3'],[4/9,4/9,1/9],k=1)[0]
