...
Y_lobes = bi.get_binary(pandas.read_csv('../../Data/CoarseGrained/Y_lobes_quan.csv'),100)
...
for task in tasks_lobes:
    ...
    if numpy.sum(y_data)!=0:
        par = []
        for k in range(0,20):
            SVM = random.choices(['SVM1','SVM2','SVM3'],[1/3,1/3,1/3],k=1)[0]
            AN = random.choices(['AN1','AN2','AN3'],[1/6,1/6,4/6],k=1)[0]
            EL = random.choices(['EL1','EL2','EL3'],[2/6,1/6,3/6],k=1)[0]
            MR = random.choices(['MR1','MR2','MR3'],[1/2,1/2,0],k=1)[0]
            SE = random.choices(['SE1','SE2','SE3'],[1/2,1/2,0],k=1)[0]
