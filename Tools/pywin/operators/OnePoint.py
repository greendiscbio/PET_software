...
from .interface.CrossOverStrategy import CrossOverStrategy
...
class OnePoint(CrossOverStrategy):
    ...
    def _generate_children(parent_1: Individual, parent_2: Individual, features: list):
        ...
        if parent_1_length == 2: cut_parent_1 = 1
        else: cut_parent_1 = random.randrange(1, parent_1_length - 1)

        if parent_2_length == 2: cut_parent_2 = 1
        else: cut_parent_2 = random.randrange(1, parent_2_length - 1)
