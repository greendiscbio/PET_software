...
f1 = open('./Optimization_30/optimization_train.csv',mode='w')
f2 = open('./Optimization_30/optimization_test.csv',mode='w')
f3 = open('./Optimization_30/optimization_parameters.csv',mode='w')
...
f2.close()
f3.close()
f1 = open('./Optimization_30/optimization_train.csv',mode='a')
f2 = open('./Optimization_30/optimization_test.csv',mode='a')
f3 = open('./Optimization_30/optimization_parameters.csv',mode='a')
for task in tasks_aal:
    ...
    for k in range(0,replicas):
        try:
            ...
            nn.record_nn_cv(dictionary_cv,folds,str(task)+'_'+str(k),'./Optimization_30/optimization')
            del dictionary_cv
        except:pass
...
train = pandas.read_csv('./Optimization_30/optimization_train.csv')
test = pandas.read_csv('./Optimization_30/optimization_test.csv')
parameters = pandas.read_csv('./Optimization_30/optimization_parameters.csv')
regions = tasks_aal+tasks_brodmann
criteria = ['accuracy','f1']
nn.keep_best(train,test,parameters,regions,criteria,'./Optimization_30/optimization')